...
#ifndef ONETWOTHREESDK_SWIFT_H
#define ONETWOTHREESDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OneTwoThreeSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14OneTwoThreeSDK15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(OneTwoThreeSDK)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(OneTwoThreeSDK)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(OneTwoThreeSDK)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(OneTwoThreeSDK)) <NSURLSessionTaskDelegate>
